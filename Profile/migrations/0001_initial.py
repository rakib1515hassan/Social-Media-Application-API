    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('name', models.CharField(max_length=50)),
                ('division', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Profile.division')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_type', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Profile.addresstype', verbose_name='AddressType')),
                ('division', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Profile.division', verbose_name='Division')),
                ('sub_division', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Profile.sub_division', verbose_name='Sub_Division')),
